...
\begin{figure}
     \centering
     \subfloat[\centering]{\includegraphics[width=0.48\textwidth]{figures/tsplot-original-Middelpos-tf1.pdf}}
    \hfill
     \subfloat[\centering]{\includegraphics[width=0.48\textwidth]{figures/dftplot-original-averaged-magnitudes-Middelpos-tf1.pdf}}
...
\begin{figure}[h!]
  ...
  \subfigure(d){\includegraphics[width=0.48\textwidth]{zplot-magnitude_phase-Middelpos-tf1;Middelpos-tf3-Z_yy.pdf}} 
