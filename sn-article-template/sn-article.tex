...
\keywords{impedance tensor, magnetotelluric method, geoelectric field, geomagnetic fiel}
...
\noindent using a method described by \cite{Sims1971}: for each $\mathbf{\widetilde{E}}$ vector component $k=x,y$, a four parameter over--determined linear regression is performed using
